//
//  BannerOverlayViewController..swift
...
class BannerOverlayViewController: UIViewController {
...
extension BannerOverlayViewController {
...
extension BannerOverlayViewController: CrossDKOverlayDelegate {
    ...
    func overlayDidFinishDismissal() {
        ...
        dismissBannerOverlayViewController()
    }
