...
SWIFT_CLASS("_TtC7CrossDK7CrossDK")
@interface CrossDK : NSObject
...
@interface CrossDK (SWIFT_EXTENSION(CrossDK)) <SKOverlayDelegate>
/// Indicates that the platform presents an overlay.
- (void)storeOverlay:(SKOverlay * _Nonnull)overlay willStartPresentation:(SKOverlayTransitionContext * _Nonnull)transitionContext;
/// Indicates that the platform is finished presenting an overlay.
- (void)storeOverlay:(SKOverlay * _Nonnull)overlay didFinishPresentation:(SKOverlayTransitionContext * _Nonnull)transitionContext;
/// Indicates that the platform dismisses an overlay.
- (void)storeOverlay:(SKOverlay * _Nonnull)overlay willStartDismissal:(SKOverlayTransitionContext * _Nonnull)transitionContext;
